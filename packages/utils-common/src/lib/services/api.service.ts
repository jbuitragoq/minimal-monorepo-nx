...
import { Course, CreateCourseRequest, UpdateCourseRequest, Student, CreateStudentRequest, UpdateStudentRequest, Enrollment, CreateEnrollmentRequest, EnrollmentWithDetails } from '../models';
